...
export const Cart = (props) => {
  ...
  // Use the cart and currencyFilter slices to render their data. cartElements should be an array of <li> elements created using the createCartItem() helper function defined at the bottom of the file.
/*
Example cart state
cart = {
...
*/
  const cartElements = Object.keys(cart).map(key => createCartItem(key));
...
//////////////////////////////////////////
  //helper function for cartElements
